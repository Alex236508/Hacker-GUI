...
addBtn(vfx,'Glitch',()=>{if(window.GlitchActive)return;window.GlitchActive=true;window.discoInt=setInterval(()=>{document.querySelectorAll('*:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor=['red','orange','yellow','green','blue','purple','pink'][Math.floor(Math.random()*7)]});},25);},()=>{clearInterval(window.discoInt);window.discoInt=null;window.discoActive=false;document.querySelectorAll('*:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>e.style.backgroundColor='');vfx.style.backgroundColor='#1b1b1b';util.style.backgroundColor='#1b1b1b';});
addBtn(vfx,'Smooth Disco',()=>{if(window.discoSmoothActive)return;window.discoSmoothActive=true;window.discoSmoothNum=0;let colors=['red','orange','yellow','green','blue','purple','pink'];window.discoSmoothInt=setInterval(()=>{window.discoSmoothNum=window.discoSmoothNum>=colors.length-1?0:window.discoSmoothNum+1;document.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor=colors[window.discoSmoothNum];e.style.transition='background-color 1s';});},1000);},()=>{clearInterval(window.discoSmoothInt);window.discoSmoothInt=null;window.discoSmoothActive=false;document.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor='';e.style.transition='';});});
...
addBtn(vfx,'Ultimate Chaos',()=>{if(window.UltimateChaosActive)return;window.UltimateChaosActive=true;function c(){return'#'+Math.floor(16777215*Math.random()).toString(16);}function r(e){return Math.floor(Math.random()*e)+1;}window.UltimateChaosLoop=setInterval(()=>{document.querySelectorAll('*').forEach(e=>{e.style.transform='rotate('+r(720-360)+'deg) scale('+Math.random()*3+') translate('+(r(400)-200)+'px,'+(r(400)-200)+'px)'; e.style.backgroundColor=c(); e.style.color=c(); e.style.position='absolute'; e.style.left=(Math.random()*window.innerWidth)+'px'; e.style.top=(Math.random()*window.innerHeight)+'px'; if(e.childNodes.length>0)e.childNodes.forEach(n=>{if(n.nodeType===Node.TEXT_NODE && n.nodeValue.trim()!==''){n.nodeValue=n.nodeValue.split('').map(l=>l===' '?l:String.fromCharCode(33+r(94))).join('');}});});document.querySelectorAll('img').forEach(e=>{e.style.transform='rotate('+r(720-360)+'deg) scale('+Math.random()*3+')';});},50);},()=>{clearInterval(window.UltimateChaosLoop);window.UltimateChaosLoop=null;window.UltimateChaosActive=false;document.querySelectorAll('*').forEach(e=>{e.style.transform='';e.style.backgroundColor='';e.style.color='';e.style.position='';e.style.left='';e.style.top='';});document.querySelectorAll('img').forEach(e=>{e.style.transform='';});});

    // Stop All VFX Button
   addBtn(vfx,'Stop All VFX',()=>{if(window.pageSpinStyle){window.pageSpinStyle.remove();window.pageSpinStyle=null;} if(window.discoActive){clearInterval(window.discoInt);window.discoInt=null;window.discoActive=false;} if(window.matrixInt){clearInterval(window.matrixInt);window.matrixCanvas.remove();window.matrixInt=null;window.matrixCanvas=null;} if(window.bubbleInt){clearInterval(window.bubbleInt);window.bubbleInt=null;window.bubbleActive=false;window.originalText.forEach(o=>o.el.nodeValue=o.text);window.originalText=[];} if(window.fullChaosLoop1){clearInterval(window.fullChaosLoop1);window.fullChaosLoop1=null;} if(window.fullChaosLoop2){clearInterval(window.fullChaosLoop2);window.fullChaosLoop2=null;} if(window.imgGlitchInt){clearInterval(window.imgGlitchInt);window.imgGlitchInt=null;document.querySelectorAll('img').forEach(e=>{if(!vfx.contains(e)&&!util.contains(e)){e.style.position='';e.style.left='';e.style.top='';}});} if(window.linkRedirectsInt){clearInterval(window.linkRedirectsInt);window.linkRedirectsInt=null;} if(window.textCorruptStyle){window.textCorruptStyle.remove();window.textCorruptStyle=null;} document.querySelectorAll('body *').forEach(e=>{if(!vfx.contains(e)&&!util.contains(e)){e.style.backgroundColor=''; e.style.color=''; e.style.transform=''; e.style.transition='';}}); vfx.style.backgroundColor='#1b1b1b'; util.style.backgroundColor='#1b1b1b'; vfx.style.color='#00ff00'; util.style.color='#00ff00';});
