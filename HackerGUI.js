...
addBtn(vfx,'Full Chaos',()=>{if(window.fullChaosActive)return;window.fullChaosActive=true;(function(){function c(){return'#'+Math.floor(16777215*Math.random()).toString(16);}function r(e){return Math.floor(Math.random()*e)+1;}let d=document;d.head.innerHTML+='<style id="fullChaosStyle">*{margin:0;overflow:hidden} #vfxGUI,#utilitiesGUI{position:fixed !important;}</style>';window.fullChaosLoop1=setInterval(()=>{document.querySelectorAll('*:not(#vfxGUI *):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor=c();e.style.color=c();e.style.transform='rotate('+r(360)+'deg) scale('+Math.random()*2+')';});},100);window.fullChaosLoop2=setInterval(()=>{document.querySelectorAll('img:not(#vfxGUI *):not(#utilitiesGUI *)').forEach(e=>{e.style.transform='rotate('+r(360)+'deg) scale('+Math.random()*2+')';});},100);})();},()=>{clearInterval(window.fullChaosLoop1);clearInterval(window.fullChaosLoop2);window.fullChaosLoop1=null;window.fullChaosLoop2=null;window.fullChaosActive=false;if(document.getElementById('fullChaosStyle'))document.getElementById('fullChaosStyle').remove();document.querySelectorAll('*:not(#vfxGUI *):not(#utilitiesGUI *)').forEach(e=>{e.style.transform='';e.style.backgroundColor='';e.style.color='';});});
