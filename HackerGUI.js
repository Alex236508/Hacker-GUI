...
addBtn(vfx,'Full Chaos',()=>{if(window.fullChaosActive)return;window.fullChaosActive=true;let d=document;function c(){return '#'+Math.floor(16777215*Math.random()).toString(16)}function r(e){return Math.floor(Math.random()*e)+1}d.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.margin='0';e.style.padding='0';e.style.overflow='hidden';e.style.transformOrigin='50% 50%';});window.fullChaosLoop1=setInterval(()=>{for(let i=0;i<10;i++){let els=d.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)');if(els.length){let el=els[r(els.length)-1];el.style.backgroundColor=c();el.style.height=r(4)+'px';d.body.style.backgroundColor=c();d.body.style.transform=r(256)>128?'scale(3) rotate('+r(35)+'deg)':'rotate(0deg) scale(1)';window.scrollTo(0,d.body.scrollHeight);}}},10);window.fullChaosLoop2=setInterval(()=>{window.scrollTo(0,0)},50);},()=>{if(window.fullChaosLoop1){clearInterval(window.fullChaosLoop1);window.fullChaosLoop1=null;}if(window.fullChaosLoop2){clearInterval(window.fullChaosLoop2);window.fullChaosLoop2=null;}window.fullChaosActive=false;d.body.style.transform='';d.body.style.backgroundColor='';d.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor='';e.style.height='';e.style.transform='';});});
    ...
    // Stop All VFX Button
   addBtn(vfx,'Stop All',()=>{if(window.pageSpinStyle){window.pageSpinStyle.remove();window.pageSpinStyle=null;}window.pageSpinActive=false;if(window.discoInt){clearInterval(window.discoInt);window.discoInt=null;window.discoActive=false;}if(window.discoSmoothInt){clearInterval(window.discoSmoothInt);window.discoSmoothInt=null;window.discoSmoothActive=false;document.querySelectorAll('*:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor='';e.style.transition='';});}if(window.glitchInt){clearInterval(window.glitchInt);window.glitchInt=null;window.glitchActive=false;}if(window.fullChaosLoop1){clearInterval(window.fullChaosLoop1);window.fullChaosLoop1=null;}if(window.fullChaosLoop2){clearInterval(window.fullChaosLoop2);window.fullChaosLoop2=null;}window.fullChaosActive=false;document.body.style.transform='';document.body.style.backgroundColor='';document.querySelectorAll('body *:not(#vfxGUI):not(#vfxGUI *):not(#utilitiesGUI):not(#utilitiesGUI *)').forEach(e=>{e.style.backgroundColor='';e.style.height='';e.style.transform='';e.style.transition='';});});
